...
export interface WorkingScheduleControllerInterface {
  updateWorkingSchedule: (establishmentId: string, workingDayId: string, updateWorkingSchedule: UpdateWorkingScheduleDto) => Promise<ResponseApi<UpdateResult>>
